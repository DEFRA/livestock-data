using LivestockData.Example.Endpoints;
using LivestockData.Example.Services;
using LivestockData.Utils;
using LivestockData.Utils.Http;
using LivestockData.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using LivestockData.Config;
using LivestockData.Utils.Logging;
using Serilog;
